...
const TRANSLATIONS = {
  en: {
    ...
    chart_title: "Patient-reported waits near you",
    ...
    emergency_strong: "If this is a medical emergency, call 911 or go to your nearest emergency department.",
    emergency_sub: "HonestER shows reported wait times — it does not determine whether you need emergency care.",
  ...
  fr: {
    ...
    chart_title: "Temps d'attente signalés par des patients près de vous",
    ...
    emergency_strong: "En cas d'urgence médicale, composez le 911 ou rendez-vous à l'urgence la plus proche.",
    emergency_sub: "HonestER affiche des temps d'attente signalés — il ne détermine pas si vous avez besoin de soins d'urgence.",
